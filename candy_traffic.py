...
def on_trackbar(pos):
    ...
    mask_red1 =cv2.inRange(hsv,(0,100,0),(10,255,255))
    mask_red2 =cv2.inRange(hsv,(160,100,0),(180,255,255))
    dst=cv2.bitwise_or(mask_red1,mask_red2)
...
src_hsv = cv2.cvtColor(filename, cv2.COLOR_BGR2HSV)
